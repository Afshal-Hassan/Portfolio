  ...
  return (
    <>
        <div className='Banner'>
            ...
            <Container style={{width:"50%",boxSizing:"border-box",display:"flex",alignItems:"center",justifyContent:"center"}} className="banner-intro">
            ...
            <Container style={{display:"flex",justifyContent:"center",alignItems:"center",boxSizing:"border-box",backgroundColor:"#1484CD"}} className="banner-wavy">
                  {/* <img src={Picture} alt="Picture" style={{width:265,height:265,borderRadius:"100%",marginLeft:150}} className="picture"/> */}
                  <Card style={{boxShadow:"0 4px 30px rgba(0,0,0,0.1)",background:"rgba(255,255,255,0.2)",borderRadius:15,border:"1px solid rgba(255,255,255,0.3)"}} className="Card">
